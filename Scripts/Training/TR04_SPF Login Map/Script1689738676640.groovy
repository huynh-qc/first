...
def account = [acc1:[email:"huye",pass:"123"], 
				acc2:[email:"yuh",pass:"987"]
			]


WebUI.openBrowser('https://auto2023.myshopify.com/account/login')

WebUI.sendKeys(input_email, account.acc1.email)

WebUI.sendKeys(input_password, account.acc1.pass)
